...
Thus we can meaningfully compare the weekday to the weekend, both visually time to time and in a mean as well, with the weekdays having an average total of `r weekdayStepAvg` steps per day and the weekends having `r weekendStepAvg` average steps per day.